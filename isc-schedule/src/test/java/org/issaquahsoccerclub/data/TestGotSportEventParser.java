...
public class TestGotSportEventParser {
    ...
    public void testSchedule() throws Exception {
        TestGotSportEventParserCallback callback = new TestGotSportEventParserCallback();
        ...
        gotSportEventParser.schedule("http://events.gotsport.com/events/schedule.aspx?EventID=83800&Gender=Boys&Age=15", callback);
